...
public class MyAdapterMultiTypeForStaggeredGridLayoutManager extends RecyclerView.Adapter{
    public static final int TYPE_ONE=1;
    public static final int TYPE_TWO=2;
    private List<String> mNames;
    public MyAdapterMultiTypeForStaggeredGridLayoutManager(List<String> names) {
        this.mNames=names;
    }
